...
void MainMenu::UpdateAnimation()
{
    ...
    else if(activeMenu == connectMenu)
    {
        ...
        //если мышка наведена на кнопку2, но не нажата ЛКМ - проиграть анимацию
...
void MainMenu::Draw()
{
    ...
    if(activeMenu == mainMenu)
    {
        ...
        //отрисовать текст на кнопке1
        text1->Draw();

        //отрисовать текст на кнопке2
        text2->Draw();
    }
    else if(activeMenu == connectMenu)
    {
